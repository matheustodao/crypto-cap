...
export default function Home() {
  ...
  const [nameFilterActive] = useMemo(() => (
    filters.map(({ active, name }) => (active && name)).filter(Boolean)
  ), [filters]);
    ...
    <>
      ...
      <Container>
        ...
        <MarketUpdateSection>
                  ...
                  index < maxFilters
                    ? (
                      <FilterBy
                        ...
                        onClick={() => handleFilterActive(filter.id)}
                      >
                        {filter.name}
                      </FilterBy>
                    )
          ...
          <TableCrypto category={nameFilterActive} />
